  ...
  return (
    <div className="min-h-screen bg-[#faf9f7] px-6 py-20">
      <div className="mx-auto max-w-3xl rounded-xl border border-[#e5ddd0] bg-white p-8 shadow-sm lg:p-12">
        ...
        <p className="mt-2 text-sm text-[#6b7280]">How to remove your data from AdAuditor Pro</p>
        ...
        <div className="prose prose-slate mt-8 max-w-none space-y-6 text-[#374151]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#171717]">1. Deleting via AdAuditor Pro</h2>
            <p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>Search and click AdAuditor Pro in the search bar.</li>
